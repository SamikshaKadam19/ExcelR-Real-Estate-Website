...
import apartmentImage from '../assets/Apartment/Apartment 3.jpg';
...
const Apartment = () => {
  ...
  const fetchProperties = () => {
    setLoading(true);
    fetch(`http://localhost:8081/Property/filtertypes/apartment`)
      ...
      <div className="property-list">
        {properties.map((property) => (
          <div key={property.prop_id} className="property-card">
            <img src={apartmentImage} alt={`Apartment ${property.prop_id}`} />
